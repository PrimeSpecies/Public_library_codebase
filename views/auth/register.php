    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        @media (max-width: 480px) {
            .auth-card {
                padding: 25px !important; /* Reduce padding so form fields have more room */
                margin: 10px; /* Ensure card doesn't hit the screen edges */
            }
            .brand-title {
...
<body style="background-color: #f8f9fa; display: flex; align-items: center; justify-content: center; min-height: 100vh; margin: 0; font-family: 'Inter', sans-serif;">
    ...
    <!-- Added 'auth-card' class -->
    <div class="auth-card" style="background: white; padding: 40px; border-radius: 20px; box-shadow: 0 10px 25px rgba(0,0,0,0.05); width: 100%; max-width: 420px; border: 1px solid rgba(0,0,0,0.05);">
        ...
        <?php if (isset($error)): ?>
            <div style="background: #fff5f5; color: #c53030; padding: 12px; border-radius: 8px; margin-bottom: 20px; font-size: 0.85rem; border: 1px solid #feb2b2; text-align: center;">
        ...
        <form method="POST" action="index.php?action=register">
            ...
            <div style="margin-bottom: 15px;">
                ...
                <input type="email" name="email" placeholder="e.g. user@domain.com" required
                       style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px; font-family: inherit; outline: none;">
            </div>
            ...
            <button type="submit" id="reg_submit" disabled
                    style="width: 100%; padding: 14px; background: #ccc; color: white; border: none; border-radius: 8px; font-weight: 600; cursor: not-allowed; transition: 0.3s;">
                Create Account
            </button>
        </form>
    ...
    <div id="loading-overlay" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(255, 255, 255, 0.95); z-index: 9999; flex-direction: column; align-items: center; justify-content: center; text-align: center; padding: 20px;">
    ...
    function checkStrength(password) {
        ...
        bar.style.backgroundColor = colors[strength] || '#eee';
        text.innerText = "Strength: " + (messages[strength] || "Too weak");
